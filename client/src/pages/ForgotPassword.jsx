...
const ForgotPassword = () => {
  const sendRecuperationEmail = (e) => {
    ...
    const URL = `https://grupo-c8-68-ft-mern-production.up.railway.app/recuperationmail/${email}`
  ...
  return (
    <section>
      ...
      <Form>
        <Text>
          We’ll send you an email with link that allows you to set new password
        </Text>
        ...
        <form onSubmit={sendRecuperationEmail}>
          ...
          <MediumSeparator></MediumSeparator>
          <MediumButton className="color-skyblue font-bold">
            CONFIRM
          </MediumButton>
        </form>
      </Form>
